...
Settings are designed to be minimal, clear, and out of the way.
...
- **Build Tooling:** Natively.dev

The codebase is structured for maintainability, modular content growth, and future expansion.
...
UI and navigation are tested to adapt cleanly across screen sizes.

---

## 🧭 Design Philosophy

Paranormal Encyclopedia does not attempt to prove or disprove the paranormal.

It documents ideas, accounts, and theories as cultural artifacts — allowing the reader to explore, reflect, and decide.
...
Developed and maintained by Andrew.  
https://stormlightfoundry.com
